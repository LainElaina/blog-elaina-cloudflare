...
- Create/Modify: `src/app/share/components/share-editing.test.tsx`
  - 覆盖真实 create/edit 字段传递、oldUrl/currentUrl 合同与改名+改 URL 场景
...
Run:
```bash
node --require /app/blog-elaina-cloudflare/test-alias-register.cjs --import jiti/register --test /app/blog-elaina-cloudflare/src/app/share/share-runtime.test.ts /app/blog-elaina-cloudflare/src/lib/load-blog.test.ts
```
Expected:
- PASS
...
```bash
git add src/app/share/page.tsx src/app/share/grid-view.tsx src/app/share/share-runtime.ts
...
```bash
git add src/app/share/components/share-card.tsx src/app/share/components/create-dialog.tsx src/app/share/components/share-folder-select.tsx src/app/share/components/share-folder-select-view-model.ts src/app/share/components/share-folder-select-view-model.test.ts
...
Run:
```bash
node --require /app/blog-elaina-cloudflare/test-alias-register.cjs --import jiti/register --test /app/blog-elaina-cloudflare/src/lib/load-blog.test.ts /app/blog-elaina-cloudflare/src/app/(home)/config-dialog/blog-migration-panel.test.ts /app/blog-elaina-cloudflare/src/app/api/blog-migration/route-files.test.ts
```
Expected:
- PASS
...
Run:
```bash
git diff -- README.md CONTRIBUTING.md && node --require /app/blog-elaina-cloudflare/test-alias-register.cjs --import jiti/register --test /app/blog-elaina-cloudflare/src/app/share/share-runtime.test.ts /app/blog-elaina-cloudflare/src/lib/content-db/share-index.test.ts
```
Expected:
...
```bash
git add README.md CONTRIBUTING.md src/app/share public/share src/lib/content-db/share-storage.ts src/lib/content-db/share-index.test.ts
